...
async fn test_reconciliation_catchup_clears_state() {
    ...
    let strategy = sequences.process_canonical_block(101, &[], 10);
...
async fn test_reconciliation_continue_preserves_state() {
    ...
    let strategy = sequences.process_canonical_block(99, &[], 10);
...
async fn test_reconciliation_with_no_pending_state() {
    ...
    let strategy = sequences.process_canonical_block(100, &[], 10);
