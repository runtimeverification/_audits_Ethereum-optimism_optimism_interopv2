...
include "VerifiedDB_nonghost.dfy"
include "ChainContainer_dummy.dfy"
include "LogsDB_dummy.dfy"
...
module Interop {
  ...
  class FrontierView {
    ...
    function BlockInfo(chainID: ChainID) : BlockInfo
      ...
      requires chainID in CHAIN_IDS
    {
      Types.BlockInfo(BlockID(0, 0), 0, 0)
    }
  ...
  class Interop {
    ...
    // TODO: Remove and replace with AllLogsDBsConsistentWithChainData
      ...
      ensures AllVerifiedCrossValid()
    {
      ...
      if verifiedDB.LastTimestamp().Some? {
                                            ...
                                            verifiedDB.Get(ts).l2Heads, map[]))
        {
          ...
          assert lastTS in old(verifiedDB.db);
